...
var createConditional = exports.createConditional = function createConditional(_ref) {
  ...
  var Conditional = function (_React$Component) {
    ...
    function Conditional(props, context) {
      ...
      var value = (0, _utils.getContextValue)(context, props.channel);
    ...
    _createClass(Conditional, [{
      ...
      value: function componentWillReceiveProps(nextProps, nextContext) {
        var value = (0, _utils.getContextValue)(nextContext, nextProps.channel);
  ...
  Conditional.contextTypes = {
    automata: _propTypes2.default.object
  };
